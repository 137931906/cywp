    ...
    <div class="m-login">
        ...
        <div class="m-login-warp">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    <input type="password" name="pwd" id="pwd" required lay-verify="required" placeholder="密码" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <img id="vImg" src="/Vcode/getCode?random1=0" onclick="changeImg()" style="width: 125px" height="38px">
                    </div>
                </div>
