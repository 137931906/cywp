...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../WEB-INF/layui/css/layui.css" />
    ...
    <div class="m-login">
        ...
        <div class="m-login-warp">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    <input type="text" name="pwd" id="pwd" required lay-verify="required" placeholder="密码" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <img id="vImg" src="/Vcode/getCode" onclick="changeImg()" style="width: 125px" height="38px">
                    </div>
                </div>
...
<script src="../WEB-INF/layui/layui.js" type="text/javascript" charset="utf-8"></script>
<script>
